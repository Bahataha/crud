...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('crud:export', ['name' => $modelName . 'Export', '--model' => $modelName, '--fillable' => $fillable]);
        $this->call('crud:import', ['name' => $modelNamespace . $modelName . 'Import', '--model' => $modelName, '--fillable' => $fillable]);
